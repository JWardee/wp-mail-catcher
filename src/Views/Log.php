...
<div class="wrap<?php if (count($logs->items) == 0) : ?> -empty<?php endif ; ?>">
    ...
    <?php if ($logs->totalItems > GeneralHelper::$logLimitBeforeWarning && $settings['auto_delete'] == false) : ?>
        <div class="notice notice-warning">
            <p>
                <?php
                printf(__('You have <strong>over %s</strong> messages stored and <a href="%s">auto-delete is disabled</a>. As a result your database can become very large, please either allow auto-delete or delete some logs.', 'WpMailCatcher'),
